 ...
 */
package org.atlanmod.analysis.serializer;
...
public class AlgaeSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == AlgaePackage.eINSTANCE)
	...
	protected void sequence_Interval(ISerializationContext context, Interval semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, AlgaePackage.Literals.INTERVAL__LOWER_ENDPOINT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, AlgaePackage.Literals.INTERVAL__LOWER_ENDPOINT));
			if (transientValues.isValueTransient(semanticObject, AlgaePackage.Literals.INTERVAL__UPPER_ENDPOINT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, AlgaePackage.Literals.INTERVAL__UPPER_ENDPOINT));
		}
