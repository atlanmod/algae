...
/**
 * This is the item provider adapter for a {@link org.atlanmod.analysis.algae.LogisticMeasure} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LogisticMeasureItemProvider extends CompositeMeasureItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LogisticMeasure_L_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LogisticMeasure_L_feature", "_UI_LogisticMeasure_type"),
				 AlgaePackage.Literals.LOGISTIC_MEASURE__L,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addKPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LogisticMeasure_k_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LogisticMeasure_k_feature", "_UI_LogisticMeasure_type"),
				 AlgaePackage.Literals.LOGISTIC_MEASURE__K,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_LogisticMeasure_type") :
