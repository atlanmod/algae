...
/**
 * This is the item provider adapter for a {@link org.atlanmod.analysis.algae.MeasureCast} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MeasureCastItemProvider extends MeasureItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MeasureCast_measure_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MeasureCast_measure_feature", "_UI_MeasureCast_type"),
				 AlgaePackage.Literals.MEASURE_CAST__MEASURE,
				 true,
				 false,
				 true,
				 null,
