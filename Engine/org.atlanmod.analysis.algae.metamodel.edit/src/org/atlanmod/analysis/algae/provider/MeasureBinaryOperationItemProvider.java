...
/**
 * This is the item provider adapter for a {@link org.atlanmod.analysis.algae.MeasureBinaryOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MeasureBinaryOperationItemProvider extends TypedMeasureItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MeasureBinaryOperation_left_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MeasureBinaryOperation_left_feature", "_UI_MeasureBinaryOperation_type"),
				 AlgaePackage.Literals.MEASURE_BINARY_OPERATION__LEFT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MeasureBinaryOperation_right_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MeasureBinaryOperation_right_feature", "_UI_MeasureBinaryOperation_type"),
				 AlgaePackage.Literals.MEASURE_BINARY_OPERATION__RIGHT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_MeasureBinaryOperation_type") :
