 ...
 * </p>
 * <ul>
 *   <li>{@link org.atlanmod.analysis.algae.impl.SampleImpl#getQuantity <em>Quantity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SampleImpl extends MinimalEObjectImpl.Container implements Sample {
	...
	protected EClass eStaticClass() {
		return AlgaePackage.Literals.SAMPLE;
	}
	...
	public EList<Measure> getQuantity() {
		if (quantity == null) {
			quantity = new EObjectContainmentEList<Measure>(Measure.class, this, AlgaePackage.SAMPLE__QUANTITY);
		}
		return quantity;
	}
