 ...
 * </p>
 * <ul>
 *   <li>{@link org.atlanmod.analysis.algae.impl.SamplingImpl#getSamples <em>Samples</em>}</li>
 *   <li>{@link org.atlanmod.analysis.algae.impl.SamplingImpl#getMeasurementProcedure <em>Measurement Procedure</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SamplingImpl extends MeasurementUncertaintyInformationImpl implements Sampling {
	...
	protected EClass eStaticClass() {
		return AlgaePackage.Literals.SAMPLING;
	}
	...
	public EList<Sample> getSamples() {
		if (samples == null) {
			samples = new EObjectContainmentEList<Sample>(Sample.class, this, AlgaePackage.SAMPLING__SAMPLES);
		}
		return samples;
	}
	...
	public void setMeasurementProcedure(String newMeasurementProcedure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgaePackage.SAMPLING__MEASUREMENT_PROCEDURE, oldMeasurementProcedure, measurementProcedure));
	}
