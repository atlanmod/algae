 ...
 * </p>
 * <ul>
 *   <li>{@link org.atlanmod.analysis.algae.impl.VariableImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.atlanmod.analysis.algae.impl.VariableImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.atlanmod.analysis.algae.impl.VariableImpl#getVibility <em>Vibility</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableImpl extends MinimalEObjectImpl.Container implements Variable {
	...
	protected EClass eStaticClass() {
		return AlgaePackage.Literals.VARIABLE;
	}
	...
	public void setValue(BigDecimal newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgaePackage.VARIABLE__VALUE, oldValue, value));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgaePackage.VARIABLE__NAME, oldName, name));
	}
	...
	public void setVibility(Visibility newVibility) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgaePackage.VARIABLE__VIBILITY, oldVibility, vibility));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AlgaePackage.VARIABLE__VALUE:
				return getValue();
			case AlgaePackage.VARIABLE__NAME:
				return getName();
			case AlgaePackage.VARIABLE__VIBILITY:
				return getVibility();
		}
