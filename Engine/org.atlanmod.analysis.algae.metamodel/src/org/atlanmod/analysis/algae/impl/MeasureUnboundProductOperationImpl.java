...
public class MeasureUnboundProductOperationImpl extends MeasureUnboundOperationImpl implements MeasureUnboundProductOperation {
	 ...
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate VALUE__EINVOCATION_DELEGATE = ((EOperation.Internal)AlgaePackage.Literals.MEASURE_UNBOUND_PRODUCT_OPERATION___VALUE).getInvocationDelegate();
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Measure.class) {
			switch (baseOperationID) {
				case AlgaePackage.MEASURE___VALUE: return AlgaePackage.MEASURE_UNBOUND_PRODUCT_OPERATION___VALUE;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case AlgaePackage.MEASURE_UNBOUND_PRODUCT_OPERATION___VALUE:
				return value();
		}
