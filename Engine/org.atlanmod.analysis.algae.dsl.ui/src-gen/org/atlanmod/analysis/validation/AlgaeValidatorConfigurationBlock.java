 ...
 */
package org.atlanmod.analysis.validation;
...
public class AlgaeValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(AlgaeConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	}
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("Algae");
		if (section == null) {
			return dialogSettings.addNewSection("Algae");
		}
		return section;
	}
}
